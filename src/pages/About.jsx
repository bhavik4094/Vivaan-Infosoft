...
import storyImg from '/stock-photo-business-colleagues-discussing-work-meeting-office.jpg';
      ...
      <section>
        <div className="container about-story-grid">
          ...
          <Reveal className="about-story-media">
            <img src={storyImg} alt="Vivaan Infosoft team discussing work" loading="lazy" />
          </Reveal>
        </div>
      </section>
